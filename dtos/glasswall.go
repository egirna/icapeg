...
type (
	// GlasswallScanFileResponse represents the scan file endpoint response payload of Glasswall
	GlasswallScanFileResponse struct {
	...
	// GlasswallErrorResponse represents the error response for the Glasswall service
	GlasswallErrorResponse struct {
		Error struct {
			Code     int      `json:"code"`
			Messages []string `json:"messages"`
		} `json:"error"`
	}
	// GWScan scan detail for Glasswall
	GWScan struct {
	...
	// GlasswallScanDetails represents the scan_details field of the Glasswall report response
	GlasswallScanDetails struct {
	...
	// GlasswallScanResults represents the scan_results field of the Glasswall report reponse
	GlasswallScanResults struct {
		ScanDetails        GlasswallScanDetails `json:"scan_details"`
	...
	// GlasswallReportResponse represents the report response payload of the Glasswall service
	GlasswallReportResponse struct {
		DataID      string               `json:"data_id"`
		Status      string               `json:"status"`
		InQueue     string               `json:"in_queue"`
		LastUpdated string               `json:"last_updated"`
		FileID      string               `json:"file_id"`
		ScanResults GlasswallScanResults `json:"scan_results"`
		FileInfo    struct {
